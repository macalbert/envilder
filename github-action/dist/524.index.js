...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 682).then(__webpack_require__.t.bind(__webpack_require__, 8444, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
