...
const client_1 = __webpack_require__(839);
...
const fromWebToken_1 = __webpack_require__(371);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(9633)));
...
var fromTokenFile = __webpack_require__(2189);
var fromWebToken = __webpack_require__(371);
