...
|---|---|---|
| `1_load.py` | Load + inject into `os.environ` | `uv run python 1_load.py` |
| `2_resolve.py` | Resolve without injecting | `uv run python 2_resolve.py` |
| `3_fluent.py` | Fluent builder with overrides | `uv run python 3_fluent.py` |
| `4_env_routing.py` | Pick map file by environment | `uv run python 4_env_routing.py` |
