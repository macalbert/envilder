...
export const es: Translations = {
  ...
  hero: {
    ...
    tabCli: 'CLI',
    tabCliDesc: 'escribe .env',
    tabSetup: 'Setup',
    tabSetupDesc: 'crea secretos',
    tabNode: 'Node.js',
    ...
    terminalComment1: '# 1. Mapea variables a rutas SSM',
    terminalComment2: '# 2. Resuelve los secretos a .env',
  ...
  demo: {
    ...
    transcript:
      'Comandos de la demo: envilder pull --map envilder.json --envfile .env. Envilder resuelve los secretos mapeados de tu proveedor en la nube configurado y escribe las variables resultantes en .env.',
